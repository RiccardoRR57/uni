...
# sh tester-prog-data_esame.sh nome_vostro_eseguibile
...
esegui_tutti_test ()
{
    ...
    esegui_test "reinizializzazione a quattro righe con riga vuota" "" "1 4 Errare Humanum  est\n \n Cogito, ergo sum\n De gustibus non   	est disputandum\n 2 7" 4 "Errare Humanum  est" "" "Cogito, ergo sum" "De gustibus non   	est disputandum"

    esegui_test "doppia reinizializzazione con seconda a vuoto" "" "1 4 Errare Humanum  est\n \n Cogito, ergo sum\n De gustibus non   	est disputandum\n 2 1 0 7" 0

    esegui_test "doppia reinizializzazione con seconda a una riga" "" "1 4 Errare Humanum  est\n \n Cogito, ergo sum\n De gustibus non   	est disputandum\n 2 1 1 prova\n 2 7" 1 "prova"

    esegui_test "salvataggio" 3 "1 4 Errare Humanum  est\n \n Cogito, ergo sum\n De gustibus non   	est disputandum\n 3 1 1 prova\n 2 7" 1 "prova"

    esegui_test "caricamento" 4 "4 2 7" 4 "Errare Humanum  est" "" "Cogito, ergo sum" "De gustibus non   	est disputandum"

    esegui_test "caricamento dopo reinizializzazione" 4 "1 3 prima prova\n \n seconda prova\n 4 2 7" 4 "Errare Humanum  est" "" "Cogito, ergo sum" "De gustibus non   	est disputandum"

    esegui_test "reinizializzazione dopo caricamento" 4 "4 1 3 prima prova\n \n seconda prova\n 2 7" 3 "prima prova" "" "seconda prova"

    esegui_test "ricerca in testo vuoto" 5 "5 2 Cogito, ergo sum\n De gustibus non   	est disputandum\n 7" 0

        esegui_test "ricerca righe vuote" 5 "1 4 Errare Humanum  est\n \n Cogito, ergo sum\n De gustibus non   	est disputandum\n 5 0 7" 0

        esegui_test "ricerca righe presenti" 5 "1 4 Errare Humanum  est\n \n Cogito, ergo sum\n De gustibus non   	est disputandum\n 5 2 Cogito, ergo sum\n De gustibus non   	est disputandum\n 7" 1 Trovate

        esegui_test "ricerca righe non presenti" 5 "1 4 Errare Humanum  est\n \n Cogito, ergo sum\n De gustibus non    	est disputandum\n 5 2 Cogito, ergo sum\n De gustibus non  est disputandum\n 7" 1 "Non trovate"

        esegui_test "ricerca con solo ultima riga del testo uguale" 5 "1 4 Errare Humanum  est\n \n Cogito, ergo sum\n De gustibus non  est disputandum\n 5 2 De gustibus non  est disputandum\n Cogito, ergo sum\n 7" 1 "Non trovate"

        esegui_test "ricerca con riga vuota nel testo" 5 "1 4 Errare Humanum  est\n \n Cogito, ergo sum\n De gustibus non    	est disputandum\n 5 2 Errare Humanum  est\n Cogito, ergo sum\n 7" 1 "Non trovate"

	esegui_test "ricerca righe presenti con salto spazi" 6 "1 4 Errare Humanum  est\n \n Cogito, ergo sum\n De gustibus non   	est disputandum\n 6 2 Cogito, ergo sum\n De gustibus non   	est disputandum\n 7" 1 Trovate

        esegui_test "ricerca righe non presenti con salto spazi" 6 "1 4 Errare Humanum  est\n \n Cogito, ergo sum\n De gustibus non    	est disputandum\n 6 2 Cogito, ergo sum\n De gustibus non  est disputandum\n 7" 1 Trovate
