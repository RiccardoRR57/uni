 ...
 * verifica se può essere ottenuto come somma di
 * quadrati interi. Implementare la verifica definendo ed utilizzando in
 ...
 * NOTA: la funzione non legge i numeri da stdin e non li stampa su stdout.
 *
