...
esegui_tutti_test ()
{
    ...
    esegui_test "stampa senza reinizializzazioni" "" "2 7" 0

    esegui_test "reinizializzazione senza stampa" "" "1 4 3 P H A U T G H C Z W E P 7" 0

    esegui_test "reinizializzazione ad un carattere con stampa" "" "1 1 1 P 2 7" 1 "P"

    esegui_test "reinizializzazione a due caratteri con stampa" "" "1 1 2 P Q 2 7" 1 "P Q"

    esegui_test "reinizializzazione a due righe con stampa" "" "1 2 1 P Q 2 7" 1 "P | Q"

    esegui_test "reinizializzazione a quattro righe con stampa" "" "1 4 3 P H A U T G H C Z W E P 2 7" 1 "P H A | U T G | H C Z | W E P"

    esegui_test "reinizializzazione con stampa" "" "1 4 3 P H A U T G H C Z W E P 2 7" 1 "P H A | U T G | H C Z | W E P"

    esegui_test "reinizializzazione con lunghezza righe uguale a 0" "" "1 2 0 2 7" 0

    # doppia reinizializzazione con seconda a vuoto

    esegui_test "doppia reinizializzazione con seconda a vuoto" "" "1 4 3 P H A U T G H C Z W E P 1 0 0 2 7" 0

    # doppia reinizializzazione con seconda a un elemento
    esegui_test "doppia reinizializzazione con seconda a un elemento" "" "1 4 3 P H A U T G H C Z W E P 1 1 1 P 2 7" 1 "P"

    esegui_test "doppia reinizializzazione con seconda a due righe" "" "1 4 3 P H A U T G H C Z W E P 1 2 1 P Q 2 7" 1 "P | Q"

    # doppia reinizializzazione con seconda a molti elementi
    esegui_test "doppia reinizializzazione con seconda a più elementi" "" "1 4 3 P H A U T G H C Z W E P 1 8 3 P H A U T G H C Z W E P P H A U T G H C Z W E P 2 7" 1 "P H A | U T G | H C Z | W E P | P H A | U T G | H C Z | W E P"
    ...
    esegui_test "salvataggio" 3 "1 4 3 P H A U T G H C Z W E P 3 2 7" 1 "P H A | U T G | H C Z | W E P"

    esegui_test "salvataggio e reinizializzazione" 3 "1 4 3 P H A U T G H C Z W E P 3 1 8 3 P H A U T G H C Z W E P P H A U T G H C Z W E P 2 7" 1 "P H A | U T G | H C Z | W E P | P H A | U T G | H C Z | W E P"

    esegui_test "caricamento" 4 "4 2 7" 1 "P H A | U T G | H C Z | W E P"

    esegui_test "caricamento dopo reinizializzazione" 4 "1 2 1 P Q 4 2 7" 1 "P H A | U T G | H C Z | W E P"

    esegui_test "reinizializzazione dopo caricamento" 4 "4 2 1 8 3 P H A U T G H C Z W E P P H A U T G H C Z W E P 2 7" 1 "P H A | U T G | H C Z | W E P | P H A | U T G | H C Z | W E P"
