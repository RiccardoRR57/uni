/* Programma per la gestione di una Catena di Anelli tutti di FERRO.
   ...
   1) inserire un anello in posizione j (un anello alla volta)
      Le posizioni ammissibili vanno dalla posizione 1 a quella
      immediatamente successiva all'ultima. Il programma da un
      messaggio di notifica nel caso in cui non sia possibile
      effettuare l'inserimento.  Se l'inserimento ha successo il
      numero totale di anelli aumenta ovviamente di una unità.  Non
      esiste un limite al numero di anelli che si possono inserire
