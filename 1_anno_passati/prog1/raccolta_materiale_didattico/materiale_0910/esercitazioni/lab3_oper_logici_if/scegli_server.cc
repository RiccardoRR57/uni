...
int main()
{
    const int indice_server1 = 1 ;
    const int indice_server2 = 2 ;

    const int tempo_veloce_server1 = 3600 ; // secondi
	...
	tempo_veloce_server1 * velocita_alta_server1;
    
    int lungh_film = 644480 ; // in KB
