/*
  ...
  generati mediante una certa funzione f(x) che, dato lÜ¢ultimo valore
  ...
  valore generato dalla funzione rand() saraÜ¢ 41 (se la funzione
  ...
  Per ottenere sequenze 'quasi' completamente casuali, si puÅÚ tentare
  di dare al seme un valore casuale. A questo scopo si puÅÚ ad esempio
  sfruttare il valore di ritorno della funzione time (per usare tale
  funzione bisogna includere ctime), che ÅË uguale al numero di secondi
