/*
 ...
 // Ritorna 1 se c e' alfanumerico, 0 altrimenti
 int isalnum(int c) ;

 // Ritorna 1 se c e' alfabetico, 0 altrimenti
 int isalpha(int c) ;

 // Ritorna 1 se c e' una cifra decimale, 0 altrimenti
 int isdigit(int c) ;

 // Ritorna 1 se c e' una cifra esadecimale, 0 altrimenti
 int isxdigit(int c) ;

 // Ritorna 1 se c e' una lettera minuscola, 0 altrimenti
 int islower(int c) ;

 // Ritorna 1 se c e' una lettera maiuscola, 0 altrimenti
 int isupper(int c) ;
