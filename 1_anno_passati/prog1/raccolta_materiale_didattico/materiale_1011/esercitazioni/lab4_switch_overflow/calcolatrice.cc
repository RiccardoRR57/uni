...
/*
 CURIOSITA' (vedrete i dettagli in Programmazione II)

 dopo aver compilato ed eseguito il programma digitare il comando
 $ echo $? [invio]
 
 Vi mostrera' il valore di uscita del programma.
 ...
 programmi eseguibili da una shell. Questo mi permette anche di
 ...
 abbiamo scelto: un valore di uscita 1 per indicare che l'operatore e'
