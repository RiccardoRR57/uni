...
Config.instname = "University of Modena and Reggio Emilia"
Config.profilename = "unimore"
Config.url = "your local eduroam® support page"
Config.email = "supporto.eduroam@unimore.it"
Config.title = "eduroam CAT"
Config.server_match = "eduradius.unimore.it"
...
Config.user_realm = "unimore.it"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:eduradius.unimore.it']
